...
class TchapHomeActivityViewModel @AssistedInject constructor(
    ...
    @AssistedFactory
    interface Factory {
        fun create(initialState: HomeActivityViewState, args: HomeActivityArgs): TchapHomeActivityViewModel
    }

    companion object : MvRxViewModelFactory<TchapHomeActivityViewModel, HomeActivityViewState> {

        @JvmStatic
        override fun create(viewModelContext: ViewModelContext, state: HomeActivityViewState): TchapHomeActivityViewModel? {
            val activity: TchapHomeActivity = viewModelContext.activity()
