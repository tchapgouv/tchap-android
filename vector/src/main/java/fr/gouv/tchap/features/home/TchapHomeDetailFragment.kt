...
class TchapHomeDetailFragment @Inject constructor(
        val homeDetailViewModelFactory: TchapHomeDetailViewModel.Factory,
    ...
    private val viewModel: TchapHomeDetailViewModel by fragmentViewModel()
