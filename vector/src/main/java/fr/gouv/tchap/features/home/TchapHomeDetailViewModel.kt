 ...
 */
class TchapHomeDetailViewModel @AssistedInject constructor(@Assisted initialState: HomeDetailViewState,
    ...
    @AssistedFactory
    interface Factory {
        fun create(initialState: HomeDetailViewState): TchapHomeDetailViewModel
    }

    companion object : MvRxViewModelFactory<TchapHomeDetailViewModel, HomeDetailViewState> {
        ...
        @JvmStatic
        override fun create(viewModelContext: ViewModelContext, state: HomeDetailViewState): TchapHomeDetailViewModel? {
            val fragment: TchapHomeDetailFragment = (viewModelContext as FragmentViewModelContext).fragment()
