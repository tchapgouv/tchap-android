...
class TchapRoomListFragment @Inject constructor(
        private val roomController: RoomSummaryController,
        val roomListViewModelFactory: TchapRoomListViewModel.Factory,
    ...
    private val roomListViewModel: TchapRoomListViewModel by fragmentViewModel()
