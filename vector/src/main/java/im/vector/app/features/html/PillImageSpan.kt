        ...
        return ChipDrawable.createFromResource(context, R.xml.pill_view).apply {
            ...
            when {
                matrixItem is MatrixItem.UserItem && matrixItem.id == session.myUserId -> {
                    chipBackgroundColor = ColorStateList.valueOf(ThemeUtils.getColor(context, com.google.android.material.R.attr.colorSecondary))
                    setTextColor(ThemeUtils.getColor(context, com.google.android.material.R.attr.colorOnSecondary))
                }
