...
class DefaultErrorFormatter @Inject constructor(
    ...
    override fun toHumanReadable(throwable: Throwable?): String {
        return when (throwable) {
            ...
            is Failure.ServerError -> {
                when {
                    ...
                    throwable.error.code == MatrixError.M_PASSWORD_TOO_SHORT -> {
                        stringProvider.getString(CommonStrings.tchap_register_pwd_too_short)
                    }
                    throwable.error.code == MatrixError.M_PASSWORD_NO_UPPERCASE -> {
                        stringProvider.getString(CommonStrings.tchap_register_pwd_no_uppercase)
                    }
                    throwable.error.code == MatrixError.M_PASSWORD_NO_DIGIT -> {
                        stringProvider.getString(CommonStrings.tchap_register_pwd_no_digit)
                    }
                    throwable.error.code == MatrixError.M_PASSWORD_NO_LOWERCASE -> {
                        stringProvider.getString(CommonStrings.tchap_register_pwd_no_lowercase)
                    }
            ...
            is ScanFailure -> stringProvider.getString(CommonStrings.tchap_scan_media_error_file_is_infected)
